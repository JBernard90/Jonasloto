...
export default function Home() {
  ...
  useEffect(() => {
    const q = query(collection(db, 'draws'), orderBy('date', 'desc'), limit(6));
    ...
    <div className="space-y-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
        ...
        <div className="flex flex-col items-center text-center p-6">
          ...
          <p className="text-gray-500 text-sm">Recevez vos gains directement sur MonCash ou NatCash en quelques minutes.</p>
        </div>
        <div className="flex flex-col items-center text-center p-6">

...
import { collection, query, orderBy, limit, onSnapshot, addDoc, Timestamp, updateDoc, doc, getDocs, deleteDoc } from 'firebase/firestore';
              ...
              {users.map(user => (
                <tr key={user.id} className="hover:bg-gray-50 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-xs text-gray-400">
                    {user.createdAt?.toDate ? format(user.createdAt.toDate(), 'dd MMM yyyy', { locale: fr }) : 'N/A'}
                  </td>
